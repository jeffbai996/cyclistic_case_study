...
Since neither R nor the packages we use in this analysis have a built-in function for determining the statistical mode of a dataset, we will define one ourselves with the name "Mode":
...
Overall, **classic bikes are more popular than electric bikes for both customer types**.  
