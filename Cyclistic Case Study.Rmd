...
# Deliverable 1: Define the Business Task
...
# Deliverable 2: Documentation - Data Cleaning and Manipulation
### Setting up the R environment
For this analysis, we will be using R in RStudio. This is due to the size of the dataset, which contains about 5.8 million records before data cleaning.
...
**Reliability**  
As seen in the data summary, over 10% of rides have missing values. Upon inspecting the data frame in RStudio, we also found a significant number of rides over 24 hours, as well as rides with end date/time before start date/time. Station IDs were also found to have changed over time, possibly indicative of changes in data collection.
...
**Conclusion**  
We are satisfied that this dataset meets our requirements for high-quality data, with the aforementioned caveats in its reliability to be remedied during data cleaning.