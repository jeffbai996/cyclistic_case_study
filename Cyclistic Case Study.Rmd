...
### Total Rides: By Day of Week and Member vs. Casual Rider
...
df_bike %>% 
  ...
  labs(x = "Day of Week", y = "Number of Rides", title = "Total Rides: By Day of Week and Member vs. Casual Rider", fill = "Rider Type") + 
  scale_y_continuous(breaks = c(100000, 200000, 300000, 400000, 500000), labels = c("100K", "200K", "300K", "400K", "500K"))
```

![Chart image](visualizations/total_rides_by_day_of_week_member_casual.png)
From this chart, we can see that casual riders tend to use Cyclistic on weekends, while members ride more on weekdays. This confirms our previous findings above, and suggests that casual riders choose Cyclistic for their mobility needs in Chicago during weekend activities.
